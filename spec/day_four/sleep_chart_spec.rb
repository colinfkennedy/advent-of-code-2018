...
describe DayFour::SleepChart do
  ...
  it "selects guard 10 as the most asleep" do
    expect(sleep_chart.most_sleepy_guard.id).to eq(10)
  end

  it "selects minute 24 as guard 10's most asleep minute" do
    expect(sleep_chart.most_sleepy_guard.most_asleep_minute).to eq(24)
  end

  it "responds with 240 for strategy_1" do
    expect(sleep_chart.strategy_1).to eq(240)
  end

  it "responds with 4455 strategy_2" do
    expect(sleep_chart.strategy_2).to eq(4455)
  end
end